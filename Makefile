...
$(error Unsupported PROFILE='$(PROFILE)'. Use cpu, vulkan, cuda, or rocm)
endif
...
.PHONY: help kronk iso build build-cpu build-vulkan build-cuda build-rocm check show-iso clean write-usb

help:
	@echo "pepikronkenix"
	@echo
	@echo "Build targets:"
	@echo "  make iso                  Build the default CPU live ISO"
	@echo "  make iso PROFILE=vulkan   Build the Vulkan live ISO"
	@echo "  make build-cpu            Build CPU ISO"
	...
	@echo
	@echo "Variables:"
	@echo "  PROFILE=$(PROFILE) (cpu|vulkan|cuda|rocm)"
	@echo "  USB=$(USB)"
	@echo "  ISO=$(ISO)"
